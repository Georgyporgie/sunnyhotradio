...
// 🔓 GLOBAL AUDIO UNLOCKER — CLEAN & MODERN
...

{
    ...
    artist: "Lovely Day",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://danceoldies10.netlify.app/Bill Withers - Lovely Day.mp3",
   timeCategory: "ballads",
volumeBoost: 0.50
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Volume 7 chillout mix01.mp3",
  timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Volume 7 chillout mix02.mp3",
   timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Volume 7 chillout mix03.mp3",
    timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Volume 7 chillout mix04.mp3",
    timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Volume 7 chillout mix05.mp3",
    timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Café del Mar Chillout Mix 20.mp3",
  timeCategory: "chillout",
volumeBoost:0.70
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.01.mp3",
  timeCategory: "ibiza",
      isLoud: true,
part:1,
loudnessValue: 0.80 
...

{
    ...
    artist: "Cafe Del Mar",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.02.mp3",
timeCategory: "ibiza",
      isLoud: true,
part:2,
loudnessValue: 0.80 
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.03.mp3",
 timeCategory: "ibiza",
      isLoud: true,
part:3,
loudnessValue: 0.80 
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.04.mp3",
  timeCategory: "ibiza",
      isLoud: true,
part:4,
loudnessValue: 0.80 
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.05.mp3",
  timeCategory: "ibiza",
      isLoud: true,
part:5,
loudnessValue: 0.80 
...

{
    ...
    artist: "Cafe Del Mar  ",
    image: "https://i.ibb.co/z6h40FW/saturday-night-fever-1977.png",
    path: "https://sunnylounge01.netlify.app/Cafe del Mar - Ibiza January 2020.06.mp3",
timeCategory: "ibiza",
      isLoud: true,
part:6,
loudnessValue: 0.80 
...
function startNewTrack(index, finalVolume) {
  ...
  // ---------------------------------------------
  // ⭐ AUTO‑QUICKFADE WATCHDOG FOR QUIET OUTROS ⭐
  // ---------------------------------------------
  ...
  const watchdog = setInterval(() => {
    ...
    const remaining = curr_track.duration - curr_track.currentTime;

    // Only check near the end of the track
    if (remaining < 8) {

      // If volume is low, increase timer
      if (curr_track.volume < lowVolumeThreshold) {
        lowVolumeTimer += 200;
      } else {
        lowVolumeTimer = 0;
      }
      ...
      if (!quickFadeTriggered && lowVolumeTimer >= lowVolumeMaxTime) {
        ...
        quickFade(curr_track, 1200);
      }
    }

    // Stop watchdog when track ends
    if (curr_track.ended || remaining <= 0) {
...
"evening-late": "images/sunnyradioca.png",
"f afternoon":   "images/sunnyradioca.png",
"loungy":   "images/loungetime.jpg",
"evening": "images/nineties.jpg"
...
// Initial display
 // Show initial tracks on page load
...
document.getElementById("now-playing-log").innerHTML = `
  ...
  !currentTrack.path.toLowerCase().includes("broadcast")  &&
